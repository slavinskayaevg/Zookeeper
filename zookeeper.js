...
let result = input("Please enter the number of the habitat you would like to view: ", 0);
while (result != "exit") {
  console.log(habitat[result]);
  result = input("Please enter the number of the habitat you would like to view: ", 0);
} 
 if (result == "exit") {
